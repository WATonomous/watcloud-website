...
- Discord: Our primary communication platform. Select `WATcloud Incoming` if you are new. After you've polished and deployed your first WATcloud project, request `WATcloud` and `Core Member`; a team lead will approve them.
