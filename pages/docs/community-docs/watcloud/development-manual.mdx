...
- Pull-request early and often. We have a lot of safeguards and automation in place to help you follow best practices.
...
We can mount the provider into our development environment by making the following changes to `docker-compose.yml`:
