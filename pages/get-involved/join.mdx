...
<Callout type="info">
Most of the projects listed below are currently in progress or in the deployment stage. The best way to join WATcloud is to fill out the [onboarding-form](/docs/utilities/onboarding-form) and express your interest in contributing. A team lead will help match you with available projects or our internal issues.
</Callout>

If you can complete one of the projects below, you are guaranteed a spot on the team!

### WATcloud VSCode Extension

{/* Internal reference: https://github.com/WATonomous/infra-config/issues/4855 */}

<Alert variant="success" className="mt-6">
  <CheckSquareIcon className='h-5 w-5'/>
  <AlertTitle>Completed</AlertTitle>
  <AlertDescription>
    This project has been completed and the source code is available [here](https://github.com/WATonomous/vscode-watcloud).
    Please don't hesitate to reach out if you have any comments or suggestions!
  </AlertDescription>
</Alert>

Build a VS Code extension that makes developing on WATcloud feel "one click": connect to a node, bootstrap the environment, and see basic cluster status without leaving the editor.

#### Feature ideas
- Auto-generate SSH config entries for WATcloud nodes
- "Connect to Node" command/button that launches VS Code Remote SSH
- First-connect bootstrap: install VS Code server + required deps automatically
- Basic cluster visibility (e.g. show maintenance/up/down summary)
- Optional: "Start Job" command that prompts for CPU/RAM/GPU and generates the right `srun` command
...
<Alert variant="success" className="mt-6">
  ...
  <AlertTitle>Completed</AlertTitle>
  <AlertDescription>
    This project has been completed and is available [here](https://github.com/WATonomous/watcloud-cli). Please don't hesitate to reach out if you have any comments or suggestions!
  </AlertDescription>
</Alert>
...
<Alert variant="success" className="mt-6">
  ...
  <AlertTitle>Completed</AlertTitle>
  <AlertDescription>
    This project has been completed using [codespell](https://github.com/codespell-project/codespell) and is available [here](https://github.com/WATonomous/watcloud-website/commit/66e3a974251c25e1ab2f75c9ad79e264f189e3d9).
    Please don't hesitate to reach out if you have any comments or suggestions!
  </AlertDescription>
</Alert>
...
<Alert variant="success" className="mt-6">
  ...
  <AlertTitle>Completed</AlertTitle>
  <AlertDescription>
	This project has been completed view the code [here](https://github.com/WATonomous/watcloud-website/commit/b5f5d209121ee5f56290505ed9d96cfaef50a4ef)
    Please don't hesitate to reach out if you have any comments or suggestions!
  </AlertDescription>
</Alert>
...
<Alert variant="success" className="mt-6">
  ...
  <AlertTitle>Completed</AlertTitle>
  <AlertDescription>
	This project has been completed and the initial version is available [here](https://github.com/WATonomous/watcloud-website/commit/83d6f113ff4c14805554a5ed7adc6cf564a97ee1)
    Please don't hesitate to reach out if you have any comments or suggestions!
  </AlertDescription>
</Alert>
...
We have a statically-generated Next.js website[^website]. Sometimes, we make typos in our hyperlinks. We would like to have a tool that can detect broken internal links. This should be a tool that runs at build-time and fails the build if it detects a broken link. The tool should be able to handle links to hashes (e.g. `#section`) in addition to links to pages. 
